...
import com.example.mym.adapters.adapters.EmptyTodoListAdapter;
import com.example.mym.adapters.adapters.ListAdapter;
import com.example.mym.database.DbController;
import com.example.mym.database.SQLExecution;
import com.example.mym.modals.TodoModal;
import com.example.mym.model.Todo;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void setupAndFillList(){
        new SQLExecution(this).runWithResult(new
                                                     SQLExecution.SQLWithReturn() {
                                                         @Override
                                                         public void execute() {
                                                             todoList = new
                                                         ...
                                                         public void executeOnUI() {
                                                             ...
                                                             listAdapter = new ListAdapter(todoList,
                                                                     isEditMode, todoListener);
                                                             if(todoList.size() == 0){
                                                                 todoRecyclerView.setAdapter(new
