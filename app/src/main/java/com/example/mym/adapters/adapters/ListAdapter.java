package com.example.mym.adapters.adapters;
...
public class ListAdapter extends RecyclerView.Adapter<ListAdapter.ViewHolder> {
    ...
    public ListAdapter(ArrayList<Todo> todoList, boolean
            isEditMode, TodoListener listeners) {
        super();
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.card.setOnLongClickListener(new
